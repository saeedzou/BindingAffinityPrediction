...
class ProtVec(word2vec.Word2Vec):
    ...
    def word2vec_init(self, vectors_txt, model_weights):
        ...
        sentences = word2vec.LineSentence(self.out)
        self.m = word2vec.Word2Vec(sentences=sentences, vector_size=self.size, sg=self.sg, window=self.window, min_count=self.vocab, callbacks=[epoch_logger])
